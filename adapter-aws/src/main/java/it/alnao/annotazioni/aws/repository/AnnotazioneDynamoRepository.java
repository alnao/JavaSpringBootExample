...
public class AnnotazioneDynamoRepository {
    ...
    @Autowired
    public AnnotazioneDynamoRepository(DynamoDbEnhancedClient dynamoDbEnhancedClient) {
        this.table = dynamoDbEnhancedClient.table("annotazioni", TableSchema.fromBean(AnnotazioneDynamoEntity.class));
    }
