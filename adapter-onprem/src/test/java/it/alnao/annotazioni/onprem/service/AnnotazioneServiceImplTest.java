package it.alnao.annotazioni.onprem.service;

import it.alnao.annotazioni.onprem.entity.AnnotazioneStoricoEntity;
import it.alnao.annotazioni.onprem.repository.AnnotazioneStoricoMongoRepository;
...
class AnnotazioneServiceImplTest {
    ...
    void aggiornaAnnotazione_salvaStoricoPrimaDiAggiornare() {
        ...
        ArgumentCaptor<AnnotazioneStoricoEntity> storicoCaptor = ArgumentCaptor.forClass(AnnotazioneStoricoEntity.class);
        verify(storicoMongoRepository).save(storicoCaptor.capture());
        AnnotazioneStoricoEntity storico = storicoCaptor.getValue();
