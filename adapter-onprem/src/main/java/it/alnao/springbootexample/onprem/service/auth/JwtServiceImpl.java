...
/**
 * Implementazione OnPrem del service JWT.
 */
@Service
@Profile("onprem")
public class JwtServiceImpl implements JwtService {
    ...
    public Optional<String> refreshToken(String refreshTokenStr) {
        return refreshTokenRepository.findByToken(refreshTokenStr)
                ...
                .map(refreshToken -> {
                    // Here we would need to get the user and generate a new token
                    // For simplicity, returning the same token for now
                    // In a real implementation, we'd fetch the user and generate a new JWT
